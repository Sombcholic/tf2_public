...
if __name__ == "__main__":
    ...
    epochs = 20
    model_name = '20230714-V1-class16-mix_model-binaryFocal_gamma4_alpha025_connectlabel_epoch' + str(epochs) + '_bs4_myself'
    ...
    train_sh = model.fit(
        train_data.content.values, [train_labels, train_keyword_data],
