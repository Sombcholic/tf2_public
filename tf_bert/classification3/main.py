...
print(train_data.OriginalTweet.values)
sys.exit(0)
...
# Run the model
checkpoint = tf.keras.callbacks.ModelCheckpoint('Bert_classification3_V1_epoch3_bs4.h5', monitor='val_accuracy', save_best_only=True, verbose=1)
...
model.save('Bert_classification3_V1_epoch3_bs4.h5')
